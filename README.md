...
This GEM is setup with Guard which watches development files and will run tests when a file changes and if green (successful), it will run rubocop for style quality
