...
require 'handlebars/helpers/string_case_formatting/pluserize'

RSpec.describe Handlebars::Helpers::StringCaseFormatting::Pluserize do
  ...
  describe 'use as handlebars helper' do
    let(:subject) do
      Handlebars::Helpers::Template.render(template, value) do |register|
        register.helper(:pluserize, &described_class.new.handlebars_helper)
      end
    end
